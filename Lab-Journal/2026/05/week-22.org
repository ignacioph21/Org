...
#+ATTR_ORG: :width 600
[[file:Assets/Day_26/Serie_completa_un_Sensor.png]]

Y el zoom para uno de los segmentos de 15 segundos (que se repite) es:

#+ATTR_ORG: :width 600
[[file:Assets/Day_26/Serie_completa_un_Sensor_zoom.png]]

La PSD usando Welch con ventanas de 20 segundos es el siguiente:

#+ATTR_ORG: :width 600
[[file:Assets/Day_26/Espectro_un_sensor.png]]
...
#+ATTR_ORG: :width 600
[[file:Assets/Day_26/serie-temporal-van-Noorloos-2003.png]]
...
#+ATTR_ORG: :width 600
[[file:Assets/Day_26/serie-temporal-tanh-ambas.png]]
...
#+ATTR_ORG: :width 600
[[file:Assets/Day_26/Espectro_un_sensor_tanhs_ambas.png]]
...
#+ATTR_ORG: :width 600
[[file:Assets/Day_26/serie-temporal-rompiente-sins.png]]

Y su espectro asociado:

#+ATTR_ORG: :width 600
[[file:Assets/Day_26/Espectro_un_sensor_sins.png]]
...
#+ATTR_ORG: :width 600
[[file:Assets/Day_26/Varios-sensores-lineal.png]]
...
#+ATTR_ORG: :width 600
[[file:Assets/Day_26/espectros-varios-lineal.png]]
...
#+ATTR_ORG: :width 600
[[file:Assets/Day_27/Burgers-series-espaciales-numéricas.png]]

La serie temporal en el centro es la siguiente:

#+ATTR_ORG: :width 600
[[file:Assets/Day_27/Burgers-serie-temporal-numérica.png]]

Con un espectro asociado (en distintas posiciones hasta la mitad) que sigue la Ley predicha por Bonneton:
#+ATTR_ORG: :width 600
[[file:Assets/Day_27/Burgers-espetros-num_ricos.png]]
...
#+ATTR_ORG: :width 600
[[file:Assets/Day_27/prueba-update-Pages.png]]
