...
#+ATTR_ORG: :width 600
[[file:../../../Assets/2026/05/Day_27/prueba-de-funcionamiento-correcto-im_genes-absolutas.png]]
...
- =-palabra= excluye la palabra.
- =pal*= busca como prefijo.
...
#+ATTR_ORG: :width 600
[[file:../../../Assets/2026/05/Day_28/espectros-tanhs-lineal-ajustes.png]]

** [13:18]
Para el forzado sinusoidal los resultados son los siguientes:

#+ATTR_ORG: :width 600
[[file:../../../Assets/2026/05/Day_28/todos-sins-alturas.png]]

Para el de subida y bajada como tangentes hiperbólicas queda:
#+ATTR_ORG: :width 600
[[file:../../../Assets/2026/05/Day_28/todos-tanhs-ambas.png]]
...
** [12:14]
 Ya está funcionando también la captura rápida. Hay que asegurarse del =after! org= o pisa la capture template la de =org=.
  [[file:~/.config/doom/config.org::*Captura rápida][Captura rápida]]
...
#+ATTR_ORG: :width 400
[[file:../../../Assets/2026/05/Day_31/prueba-captura.png]]

Para archivos del explorador de archivos también:

#+ATTR_ORG: :width 400
[[file:../../../Assets/2026/05/Day_31/prueba-captura-2.png]]
