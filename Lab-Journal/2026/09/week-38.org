...
** [18:30]
Estuve probando correr simulaciones más largas con PyBurgers. Para esto cambié el planning a fftw_estimate, para que en vez de probar todos los algoritmos elija alguno usando algún criterio. Además le puse para correr en 6 =threads=.
...
** [09:50]
Sigo con la parte numérica. Pareciera que las funciones de estructuras varíasn bastante dependiendo del frame de la evolución temporal, y además parecen haber regiones, donde el comportamiento es más o menos parecido al del experimento.

** [10:54]
En general siempre la de dos puntos da distinta a la de más puntos, con exponentes menores. Hay una región, justo después del forzado, donde la de dos puntos satura y las demás crecen, y después otra región a frecuencias más altas donde todas saturan después de =p=1=, pero en valores mayores a 1. Esto para la simulación de $T=500$ y $fs=200$, para el último frame que es en =0.15= y una viscosidad pequeña de 5e-3. Al ir a tiempo smás cercanos a la condición inicial desaparece el régimen donde los exponentes de las funciones de estructura saturan.

** [11:10]
Tengo esta interfaz para analizar:

#+ATTR_ORG: :width 500
[[file:../../../Assets/2026/09/Day_17/an_lisis_mediciones.png]]

Y para lo numérico:

#+ATTR_ORG: :width 500
[[file:../../../Assets/2026/09/Day_17/an_lisis_num_rico.png]]
